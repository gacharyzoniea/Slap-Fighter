Shader "FlexibleCelShader/Cel OutlineTransparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			Tags{ "LightMode" = "ForwardBase" "Queue" = "Opaque" "RenderType" = "Opaque"}
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				col = (emmision * eIntensity + col * (1 - eIntensity)) * _Color;
